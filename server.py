...
def send_android_notification(message, key=None):
	pb = Pushbullet('o.1L0flzi0OpI4TJNaMHUWVLsZhgS9hquG')
	push = pb.push_note("Garbage Segregator", message)
	return
...
model = load_model('model128.hdf5')
file_name = 'X.jpg'
